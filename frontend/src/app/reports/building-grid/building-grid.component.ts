...
@Component({
  selector: 'app-building-grid',
  templateUrl: './building-grid.component.html',
  styleUrls: ['./building-grid.component.css']
})
export class BuildingGridComponent implements OnInit, OnDestroy, AfterViewInit {
