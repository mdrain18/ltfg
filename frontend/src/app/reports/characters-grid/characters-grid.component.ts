...
export class CharactersGridComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  private serverSideDataSource: IServerSideDatasource = {
    getRows: (params: IServerSideGetRowsParams) => {
      ...
      this.gridService.getCharacterData(getRowsRequestDTO)
...
// Set up the columns for the grid
  ...
  public  rowData: GetCharactersDTO[];
